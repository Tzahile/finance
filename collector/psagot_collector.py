...
class PsagotCollector(object):
    ...
    def get_data(self, start_date=datetime.datetime.now() - datetime.timedelta(days=3*365), end_date=datetime.datetime.now()):
        ...
        while end_date.year - start_date.year > 0:
            ...
            transactions.extend(self.send_request(self._request_data(access_token,
